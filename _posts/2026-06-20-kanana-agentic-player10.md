...
이번 작업을 하면서 MCP 서버는 기능 구현만큼이나 설명과 응답 설계가 중요하다는 점을 느꼈습니다. AI가 도구를 호출하는 구조에서는 도구 이름, 설명, 입력값, 출력 형식이 모두 사용성에 영향을 줍니다.

Report Guard를 준비하면서 가장 많이 고민한 부분은 어디까지 도와주는 것이 적절한가였습니다. 리포트 작성 자체를 대신해주는 방향은 피하고, 사용자가 이미 작성한 문서를 더 잘 점검할 수 있도록 돕는 방향을 유지하려고 했습니다.
